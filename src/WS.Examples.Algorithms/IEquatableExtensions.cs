...
/// <summary>
/// Collection of comparison helpers for types implementing <see cref="IEquatable{T}"/>.
/// </summary>
/// <remarks>
...
{
    extension<T>(T _) where T : IEquatable<T>
    {
        /// <summary>
        ...
        public static bool operator ==(T left, T right) => Equals(left, right);
